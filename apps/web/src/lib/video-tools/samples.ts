...
export const SAMPLES: Record<SourceId, MetricVideoData> = {
  "github-stars": {
    ...
    value: 238412,
    unit: "stars",
    // The live source's delta is the last 12 points of this same curve.
    delta: { value: 43253, label: "+43,253 in the last 12 months" },
  ...
  "producthunt-launch": {
    ...
    tagline: "Videos, made by talking to an agent",
    value: 1284,
    unit: "upvotes",
    badge: "#1 Product of the Day",
    secondary: { value: 212, unit: "comments" },
    delta: null,
    series: null,
    avatar: null,
    url: "https://www.producthunt.com/posts/genmotion",
    accent: "#ff6154",
  },
};
