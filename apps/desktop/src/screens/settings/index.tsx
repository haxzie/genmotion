...
// Solar "Chart Square" (bold duotone) — https://creativecommons.org/licenses/by/4.0/
function BillingIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
      <path opacity="0.5" d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z" />
      <path d="M7.25 11a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-.75.75H8a.75.75 0 0 1-.75-.75v-6Zm4-4a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 .75.75v10a.75.75 0 0 1-.75.75H12a.75.75 0 0 1-.75-.75V7Zm4 6a.75.75 0 0 1 .75-.75h.5a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-.75.75H16a.75.75 0 0 1-.75-.75v-4Z" />
    </svg>
  );
}
