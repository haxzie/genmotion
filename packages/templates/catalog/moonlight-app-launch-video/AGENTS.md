# Moonlight — side job assistant

A square launch video for an AI assistant that runs your side hustle: it triages the client inbox, turns down your boss for you, keeps the gig calendar straight, and hands the night back to you.

Started from the **Moonlight app launch video** template. A GenMotion video project powered by the Three.js engine. Scenes are plain
