...
A voice prompt turns into a running app: speak an idea, watch it build, cycle through finished dashboards, then land on the Codex mark.

Started from the **Codex launch video** template. A GenMotion video project. Scenes are React components rendered frame by frame
