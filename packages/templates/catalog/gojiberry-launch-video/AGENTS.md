...
A B2B SaaS launch that opens on the cold DM nobody answers, then shows the product finding buyers who are already showing intent: a browser mock, LinkedIn-style profile cards, radar and intent-signal panels, and a voiceover carrying every beat to the wordmark reveal.

Started from the **Gojiberry launch video** template. A GenMotion video project. Scenes are React components rendered frame by frame
