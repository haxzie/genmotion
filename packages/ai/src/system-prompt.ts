...
// Re-exported so `@genmotion/ai/prompt` stays the one import for every
// engine's guide — the desktop app asks this module for whichever its project
// runs on.
export { THREE_AUTHORING_GUIDE } from "./three-guide";
export { DESIGN_STANDARDS, VIDEO_NOT_A_WEBSITE } from "./design-guide";
